...
function getItemElement() {
  ...
  if(choice==true){
    ...
    if(id==cards.length)
    {
      console.log("id: "+id+" cards.length: "+cards.length)
      elem = $(".finish").clone();
    }else{
      elem = cards[id];
...
function createNavBtn(){
  ...
  setTimeout(function(){
    if(length - 4 - lastCount>=0 && length%2==0) {
