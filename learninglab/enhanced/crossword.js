        ...
        for(var r = 0; r < grid.length; r++){
            ...
            for(var c = 0; c < grid[r].length; c++){
                ...
                if(cell == null){
                    ...
                    if(cell["across"]!=null){
                        index += " across='"+cell["across"].index+"'"
                    }
                    if(cell["down"]!=null){
                        index += " down='"+cell["down"].index+"'"
                    }
                }
...
//                console.log(cell);
                ...
                if(is_start_of_word) {
                    ...
                    html.push("<td "+index+" class='" + css_class + "' pos='" + r + ", " + c + "' style=\"background-image:url('" + img_url + "')\" placeholder='"+label+"'>");
                    label++;			
                } else {
                    html.push("<td "+index+" class='" + css_class + "' pos='" + r + ", " + c + "'>");					
                }
