for(i = 0; i < data.length; i++) {
        ...
        /* Create section for each question */
        section = section + "<div class='section'><form class='ac-custom ac-radio ac-circle' autocomplete='off'><h4>"+data[i].question+"</h4><ul show='"+data[i].show+"'><li><input id='r"+i+"1' type='radio' name='r"+i+"' value='True'><label for='r"+i+"1'>True</label></li><li><input id='r"+i+"2' type='radio' name='r"+i+"' value='False'><label for='r"+i+"2'>False</label></li></ul></form>";
