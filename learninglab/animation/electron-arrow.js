...
// stage content:
(lib.electronarrow = function(mode,startPosition,loop,reversed) {
...
if (reversed == null) { reversed = false; }
	...
	this.shape.setTransform(100,98.325);
	...
	mask._off = true;
	mask.graphics.p("ApNJ/QgxAAABgxIAAybQgBgxAxAAISbAAQAxAAAAAxIAASbQAAAxgxAAg");
	mask.setTransform(100,98.325);

	// arrow2
	this.instance = new lib.arrowgrow();
	this.instance.setTransform(129.25,64.95,1,1,180);
	...
	this.timeline.addTween(cjs.Tween.get(this.instance).wait(50).to({_off:false},0).wait(40));

	// mask1 (mask)
	var mask_1 = new cjs.Shape();
	mask_1._off = true;
	mask_1.graphics.p("ApNJ/QgxAAABgxIAAybQgBgxAxAAISbAAQAxAAAAAxIAASbQAAAxgxAAg");
	mask_1.setTransform(100,98.325);

	// arrow1
	this.instance_1 = new lib.arrowgrow();
	this.instance_1.setTransform(70.75,132.45);
...
p.nominalBounds = new cjs.Rectangle(133.7,132,32.70000000000002,32.69999999999999);
// library properties:
lib.properties = {
	id: 'B8E781E8E666453086CB51882708B060',
	width: 200,
	height: 200,
	fps: 24,
	color: "#FFFFFF",
...
an.compositions['B8E781E8E666453086CB51882708B060'] = {
