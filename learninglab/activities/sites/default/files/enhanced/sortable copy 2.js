jQuery.fn.sortable = function (opt) {
    ...
    function createPlaceholder() {
        ...
        jQuery.each(elMargin, function (key, value) {
    ...
    function initElements() {
        jQuery.each(oriElements, function (i, el) {
            var elPadding = {};
    ...
    function updateCurrentStatus() {
        currentElements = [];
        jQuery.each(oriElements, function (i, el) {
            var currentIndex = jQuery(el).data('current-index');
    ...
    function updatePose() {
        jQuery.each(currentElements, function (i, el) {
    ...
    function getMatchVertical() {
        var map = [];
        var lastIndex = 0;
        jQuery.each(currentStatus.poseList, function (index, pose) {
            map[pose.top] = index;
        });
    ...
    function move(oldIndex, newIndex) {
        ...
        el = jQuery(currentElements[oldIndex]);
    ...
    oriElements.bind('mousedown', preventDefault).bind('touchstart', preventDefault);
    ...
    output.getOrder = function () {
        var result = [];
        jQuery.each(currentElements, function (i, el) {
            result.push(jQuery(el).data('ori-index'));
        });
        return result;
    }
